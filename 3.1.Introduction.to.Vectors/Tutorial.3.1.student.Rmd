...
Add names to the `no_antibiotic_OD` vector according to the following table:
...
Create a new vector (with named elements) containing these two measurements. Call it "no_antibiotic_OD_new_reps".
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
...
Use the vector `negative_three_to_three` to create a new vector called `negative_four_to_four`, by using the `c()` function to add a -4 to the beginning and a 4 to the end.
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
